...
STRONG_STEMS = [
    ...
    # Названия должностей, где слабый маркер стоит в роли профессии.
    # Без них терялись «Специалист по обучению» и «Менеджер по оценке» —
    # HR-контекста в названии нет, а вакансия целевая.
    ...
    "руководител оценк", "специалист развити", "менеджер развити",
]
...
def apply_filters(vacancies: list[Vacancy]) -> list[Vacancy]:
    """Порядок: похоже ли на вакансию → не резюме → релевантность → гео →
    стоп-слова → вайтлист-исключение."""
